...
#ifndef DECOMPRESSOR_SRC_INTERP_FORMATHELPERS_TEMPLATES_H_
#define DECOMPRESSOR_SRC_INTERP_FORMATHELPERS_TEMPLATES_H_
...
#endif  // DECOMPRESSOR_SRC_INTERP_FORMATHELPERS_TEMPLATES_H_
